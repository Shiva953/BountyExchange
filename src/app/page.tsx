...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black font-sans pt-16">
      ...
      <div className="fixed top-32 left-1/2 -translate-x-1/2 z-40 w-full max-w-2xl px-4">
      ...
      <main className="flex min-h-screen w-full max-w-5xl flex-col items-center justify-center py-32 px-8 mt-8">
